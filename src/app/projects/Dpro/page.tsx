...
export default function DproProject() {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-20 pb-12 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-6 neon-text animate-fadeInUp">Dpro</h1>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
            {activeTab === "about" && (
              <div>
                <h2 className="text-2xl font-semibold mb-4">About Dpro</h2>
                <p className="text-gray-300 mb-4">
                  Dpro is a minimalist, yet powerful task management application designed for procrastinators and
                ...
                <p className="text-gray-300">
                  Built with modern web technologies, Dpro offers a seamless experience across devices, ensuring
            ...
            {activeTab === "usage" && (
              <div>
                <h2 className="text-2xl font-semibold mb-4">How to Use Dpro</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-300">
                  ...
                  <li>Let Dpro&apos;s AI suggest the best order to tackle your tasks.</li>
